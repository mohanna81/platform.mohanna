...
const MyRisksHeader: React.FC<MyRisksHeaderProps> = ({ onNewRisk }) => {
  ...
  // Facilitators review/approve risks, they don't submit their own -- only
  // Organization Users (and Admins) create risks here.
  const canCreateRisk = user?.role !== 'Facilitator';
